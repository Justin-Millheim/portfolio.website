...
// a guest. Guest keeps everything on-device (fully offline); signing in syncs
// across devices and lifts any guest history up to the cloud.
export default function AuthGate({
  ...
  async function sendReset() {
    ...
    setLoading(true);
    try {
      const redirectTo = typeof window !== "undefined" ? `${window.location.origin}/program` : undefined;
    ...
    <div className="t-wrap t-fadein" style={{ paddingTop: 64, maxWidth: 420 }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 28 }}>
        ...
        <p style={{ color: "var(--t-muted)", fontSize: 14, margin: 0 }}>
          Your coach&apos;s 4-week program, tracked.
        </p>
      </div>
      ...
      {mode === "choose" ? (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <p className="t-mono" style={{ textAlign: "center", color: "var(--t-faint)", fontSize: 11, marginTop: 6, lineHeight: 1.6 }}>
            Guest keeps your progress on this device only.<br />Sign in to sync across devices.
          </p>
          {!supabase && (
