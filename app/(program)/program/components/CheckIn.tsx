...
import type { CheckIn as CheckInType } from "@/lib/program/types";
import { MOODS, MOOD_LABEL } from "@/lib/program/format";
    ...
    <div className="t-wrap t-fadein" style={{ paddingTop: 48 }}>
      ...
      {!pre && (
        <div style={{ marginBottom: 24 }}>
          ...
          <textarea
            rows={3}
            placeholder="Felt strong on the bench, hamstrings a bit tight…"
            value={note}
