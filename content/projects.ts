...
export const projects: Project[] = [
  ...
  { id: "engrave", title: "Laser-Engraving Design Skill", tags: ["AI Tools", "Made by hand"], blurb: "End-to-end workflow that outputs engraver-ready black-and-white vector art for custom gifts.", featured: true, post: "laser-engraving-skill", cover: "/projects/engrave.svg" },
